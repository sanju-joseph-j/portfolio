...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_qvtyz8u', 'template_w4ujzir', form.current, {
        publicKey: 'mC_-HwboOSd9liDPg',
      })
      e.target.reset()
  };
    return(
        <section className="contact section" id="contact">
            ...
            <div className="contact__container container grid">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data mail">iamsanjujoseph@gmail.com</span>

                        <a href="mailto:iamsanjujoseph@gmail.com" className="contact__button">
                            Write me{" "} 
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact_card-data">7092102195</span>

                        <a href="https://wa.me/7092102195?text=Hello,%20I%27m%20Sanju%20Joseph,%20How%20can%20I%20help%20you?" className="contact__button">
                            Write me{" "} 
                            <i className="bx bx-right-arrow-alt 
                            contact__button-icon"></i>
                        </a>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact_card-data">@sanju_Joseph</span>

                        <a href="https://t.me/Sanju_Joseph?text=Hello,%20I%27m%20Sanju%20Joseph,%20How%20can%20I%20help%20you?" className="contact__button">
                            Write me{" "} 
                            <i className="bx bx-right-arrow-alt 
                            contact__button-icon"></i>
                        </a>
            ...
            <div className="contact__content">
                <h3 className="contact__title contact__title2">Write me your project</h3>
